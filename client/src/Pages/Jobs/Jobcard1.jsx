      ...
      <div className='new-container-43'>
        <div className='detail-43'>
          ...
          <div className='detail-header-43'>
            <img src={googleimage} alt='Google Logo'></img>
            <h2>Google</h2>
            <p>Data Science</p>
          </div>
          ...
          <div className='detail-desc-43'>
            <div className='about-43'>
              <h4>About Company</h4>
              <p>
                Google LLC is a leading technology company specializing in internet services, including search, advertising, cloud
                computing, and various innovative technologies.
              </p>
              {/* <a href="#">Read more</a> */}
            </div>
            <hr className='divider-43' />
