          ...
          <div className="deatil-header-43">
             ...
             <div className="detail-desc-43">
              <div className="about-43">
                <h4>About Company</h4>
                <p>Apple Inc. is a multinational technology company renowned for designing and manufacturing consumer electronics, software, and online services, including the iPhone, Mac computers, and the App Store.</p>
